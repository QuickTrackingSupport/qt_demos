    ...
    <div class="setting">
        ...
        <div class="setting-user">
            ...
            <div class="user-event">
                ...
                <textarea auto-height placeholder="请填写用户属性，支持js object对象，仅支持一级kv结构" @input="onUserPropertiesChanged" :value="JSON.stringify(up)"/>
            </div>
...
export default {
    ...
    methods: {
        ...
        setUserProfile() {
            ...
            UmengSDK.sendEvent('$$_user_profile', this.up, 'OTHER')
        },
        toJSONString(input) {
            const keyMatcher = '([^",{}\\s]+?)';
            const valMatcher = '(.,*)';
